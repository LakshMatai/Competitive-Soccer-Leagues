...
df = pd.read_csv("data/premierLeague/season-1819.csv")
finalList=[]
season="18/19"
...
for index,row in df.iterrows():
    ...
    for team in finalList:
        ...
        elif team["TeamName"]==row["AwayTeam"]: 
...
finalDf.to_csv("generatedDataset/premierLeague.csv")